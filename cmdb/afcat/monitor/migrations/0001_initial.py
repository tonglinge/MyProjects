    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ns', models.IntegerField(primary_key=True, serialize=False)),
            ],
            options={
                'managed': False,
                'db_table': 'history',
        ...
        migrations.CreateModel(
            name='MonitorHostGroups',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('host_id', models.IntegerField(verbose_name='主机')),
                ('group', models.ForeignKey(db_column='group_id', on_delete=django.db.models.deletion.CASCADE, to='monitor.MonitorGroups')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('corr_conditionid', models.OneToOneField(db_column='corr_conditionid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='monitor.CorrCondition')),
                ('operator', models.IntegerField()),
            ],
            options={
                'managed': False,
        ...
        migrations.CreateModel(
            name='EventRecovery',
            fields=[
                ('eventid', models.OneToOneField(db_column='eventid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, related_name='EventRecovery_eventid', serialize=False, to='monitor.Events')),
        ...
        migrations.CreateModel(
            name='GraphDiscovery',
            fields=[
                ('graphid', models.OneToOneField(db_column='graphid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, related_name='GraphDiscovery_graphid', serialize=False, to='monitor.Graphs')),
            ],
            options={
                'managed': False,
        ...
        migrations.CreateModel(
            name='GroupDiscovery',
            fields=[
                ('groupid', models.OneToOneField(db_column='groupid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='monitor.Groups')),
                ('name', models.CharField(max_length=64)),
                ('lastcheck', models.IntegerField()),
                ('ts_delete', models.IntegerField()),
            ],
        ...
        migrations.CreateModel(
            name='HostDiscovery',
            fields=[
                ('hostid', models.OneToOneField(db_column='hostid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, related_name='HostDiscovery_hostid', serialize=False, to='monitor.Hosts')),
                ('host', models.CharField(max_length=64)),
                ('lastcheck', models.IntegerField()),
                ('ts_delete', models.IntegerField()),
            ],
        ...
        migrations.CreateModel(
            name='HostInventory',
            fields=[
                ('hostid', models.OneToOneField(db_column='hostid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='monitor.Hosts')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('interfaceid', models.OneToOneField(db_column='interfaceid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, related_name='InterfaceDiscovery_interfaceid', serialize=False, to='monitor.Interface')),
            ],
            options={
                'managed': False,
        ...
        migrations.CreateModel(
            name='Opcommand',
            fields=[
                ('operationid', models.OneToOneField(db_column='operationid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='monitor.Operations')),
                ('type', models.IntegerField()),
                ('execute_on', models.IntegerField()),
                ('port', models.CharField(max_length=64)),
                ('authtype', models.IntegerField()),
        ...
        migrations.CreateModel(
            name='Problem',
            fields=[
                ('eventid', models.OneToOneField(db_column='eventid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, related_name='Problem_eventid', serialize=False, to='monitor.Events')),
                ('source', models.IntegerField()),
                ('object', models.IntegerField()),
                ('objectid', models.BigIntegerField()),
                ('clock', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('taskid', models.OneToOneField(db_column='taskid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='monitor.Task')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('triggerid', models.OneToOneField(db_column='triggerid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, related_name='TriggerDiscovery_triggerid', serialize=False, to='monitor.Triggers')),
            ],
            options={
                'managed': False,
