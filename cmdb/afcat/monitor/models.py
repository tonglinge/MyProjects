...
class ApplicationTemplate(models.Model):
    ...
    applicationid = models.ForeignKey('Applications', models.DO_NOTHING, db_column='applicationid', related_name="ApplicationTemplate_application_templateid")
    templateid = models.ForeignKey('Applications', models.DO_NOTHING, db_column='templateid', related_name="ApplicationTemplate_applicationid")
...
class EventRecovery(models.Model):
    eventid = models.OneToOneField('Events', models.DO_NOTHING, db_column='eventid', primary_key=True, related_name="EventRecovery_eventid")
    r_eventid = models.ForeignKey('Events', models.DO_NOTHING, db_column='r_eventid', related_name="EventRecovery_r_eventid")
    c_eventid = models.ForeignKey('Events', models.DO_NOTHING, db_column='c_eventid', blank=True, null=True, related_name="EventRecovery_c_eventid")
...
class GraphDiscovery(models.Model):
    ...
    parent_graphid = models.ForeignKey('Graphs', models.DO_NOTHING, db_column='parent_graphid', related_name="GraphDiscovery_parent_graphid")
...
class Graphs(models.Model):
    ...
    ymin_itemid = models.ForeignKey('Items', models.DO_NOTHING, db_column='ymin_itemid', blank=True, null=True, related_name="Graphs_ymin_itemid")
    ymax_itemid = models.ForeignKey('Items', models.DO_NOTHING, db_column='ymax_itemid', blank=True, null=True, related_name="Graphs_ymax_itemid")
    flags = models.IntegerField()
...
class HostDiscovery(models.Model):
    ...
    parent_hostid = models.ForeignKey('Hosts', models.DO_NOTHING, db_column='parent_hostid', blank=True, null=True, related_name="HostDiscovery_parent_hostid")
...
class Hosts(models.Model):
    ...
    name = models.CharField(max_length=128)
    flags = models.IntegerField()
    templateid = models.ForeignKey('self', models.DO_NOTHING, db_column='templateid', blank=True, null=True, related_name="Hosts_templateid")
    description = models.TextField()
...
class HostsTemplates(models.Model):
    ...
    templateid = models.ForeignKey(Hosts, models.DO_NOTHING, db_column='templateid', related_name="HostsTemplates_templateid")
...
class InterfaceDiscovery(models.Model):
    ...
    parent_interfaceid = models.ForeignKey(Interface, models.DO_NOTHING, db_column='parent_interfaceid', related_name="InterfaceDiscovery_parent_interfaceid")
...
class ItemDiscovery(models.Model):
    ...
    parent_itemid = models.ForeignKey('Items', models.DO_NOTHING, db_column='parent_itemid', related_name="ItemDiscovery_parent_itemid")
    key_field = models.CharField(db_column='key_', max_length=255)  # Field renamed because it ended with '_'.
    lastcheck = models.IntegerField()
    ts_delete = models.IntegerField()
...
class Problem(models.Model):
    eventid = models.OneToOneField(Events, models.DO_NOTHING, db_column='eventid', primary_key=True, related_name="Problem_eventid")
    source = models.IntegerField()
    object = models.IntegerField()
    objectid = models.BigIntegerField()
    clock = models.IntegerField()
    ns = models.IntegerField()
    r_eventid = models.ForeignKey(Events, models.DO_NOTHING, db_column='r_eventid', blank=True, null=True, related_name="Problem_r_eventid")
...
class ServicesLinks(models.Model):
    ...
    serviceupid = models.ForeignKey(Services, models.DO_NOTHING, db_column='serviceupid', related_name="ServicesLinks_serviceupid")
...
class SysmapsElements(models.Model):
    ...
    iconid_on = models.ForeignKey(Images, models.DO_NOTHING, db_column='iconid_on', blank=True, null=True, related_name="SysmapsElements_iconid_on")
...
class SysmapsLinks(models.Model):
    ...
    selementid2 = models.ForeignKey(SysmapsElements, models.DO_NOTHING, db_column='selementid2', related_name="SysmapsLinks_selementid2")
    drawtype = models.IntegerField()
    color = models.CharField(max_length=6)
    label = models.CharField(max_length=2048)
...
class TriggerDepends(models.Model):
    ...
    triggerid_up = models.ForeignKey('Triggers', models.DO_NOTHING, db_column='triggerid_up', related_name="TriggerDepends_triggerid_up")
...
class TriggerDiscovery(models.Model):
    triggerid = models.OneToOneField('Triggers', models.DO_NOTHING, db_column='triggerid', primary_key=True, related_name="TriggerDiscovery_triggerid")
