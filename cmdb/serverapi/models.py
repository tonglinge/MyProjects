...
class Asset(models.Model):
    ...
    asset_type = models.CharField(choices=asset_type_choices, max_length=64, default='server')  # 必须
    name = models.CharField(max_length=64, unique=True)  # 必须
    sn = models.CharField(u'资产SN号', max_length=128, unique=True)  # 必须
